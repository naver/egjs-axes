    ...
    ***************************************************************************** */
    ...
    function () {
      ...
      __proto._onPanstart = function (event) {
        ...
        var panEvent = activeInput.extendEvent(event);
      ...
      __proto._attachWindowEvent = function (activeInput) {
        var _this = this;
      ...
      __proto._detachWindowEvent = function (activeInput) {
        var _this = this;
      ...
      __proto._attachElementEvent = function (observer) {
        ...
        activeInput === null || activeInput === void 0 ? void 0 : activeInput.start.forEach(function (event) {
          ...
          (_a = _this.element) === null || _a === void 0 ? void 0 : _a.addEventListener(event, _this._onPanstart, false);
        });
      };
      ...
      __proto._detachElementEvent = function () {
        ...
        activeInput === null || activeInput === void 0 ? void 0 : activeInput.start.forEach(function (event) {
          ...
          (_a = _this.element) === null || _a === void 0 ? void 0 : _a.removeEventListener(event, _this._onPanstart, false);
        });
        this._enabled = false;
        this._observer = null;
      };
    ...
    function (_super) {
      ...
      __proto._onPanstart = function (event) {
        ...
        this._attachWindowEvent(activeInput); // TODO: how to do if element is ellipse not circle.
