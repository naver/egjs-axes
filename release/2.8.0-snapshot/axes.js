...
(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define(['@egjs/agent', '@egjs/component'], factory) :
    (global.eg = global.eg || {}, global.eg.Axes = factory(global.eg.agent,global.eg.Component));
}(this, (function (getAgent,Component) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    function () {
      ...
      __proto.stopAnimation = function (axes, option) {
        if (this._animateParam && axes.length) {
          ...
          this._raf = null;
          this.em.triggerAnimationEnd(!!(option === null || option === void 0 ? void 0 : option.event));
        }
      };
      ...
      __proto.animationEnd = function () {
        ...
        if (Object.keys(circularTargets).length > 0) {
          this.setTo(this.axm.map(circularTargets, function (v, opt) {
            return getCirculatedPos(v, opt.range, opt.circular);
          }));
        }
      ...
      __proto.updateAnimation = function (options) {
        ...
        if (options === null || options === void 0 ? void 0 : options.destPos) {
          var currentPos = this.axm.get(); // When destination is changed, new delta should be calculated as remaining percent.
      ...
      __proto._animateLoop = function (param, complete) {
        ...
        if (param.duration) {
          ...
          var loop_1 = function () {
            ...
            var toPos = _this.axm.map(prevPos_1, function (pos, options, key) {
            ...
            var isCanceled = !_this.em.triggerChange(toPos, false, prevPos_1);
            prevPos_1 = toPos;
            ...
            if (easingPer >= 1) {
              ...
              if (!equal(animateParam.destPos, _this.axm.get(Object.keys(animateParam.destPos)))) {
                _this.em.triggerChange(animateParam.destPos, true, prevPos_1);
              }
    ...
    function () {
      ...
      __proto.triggerChange = function (pos, isAccurate, depaPos, option, holding) {
        ...
        var result = this._axes.trigger(new Component.ComponentEvent("change", param));

        if (inputEvent) {
          axm.set(param.set().destPos);
        }
      ...
      __proto.triggerAnimationStart = function (param) {
        ...
        param.depaPos = roundDepa;
        param.setTo = this._createUserControll(param.destPos, param.duration);
        return this._axes.trigger(new Component.ComponentEvent("animationStart", param));
      };
      /**
      ...
      __proto._getBounceRatio = function (pos) {
        return this._axes.axm.map(pos, function (v, opt) {
    ...
    function () {
      ...
      __proto.extendEvent = function (event) {
        ...
        var velocityX = prevEvent ? offsetX / (event.timeStamp - prevEvent.srcEvent.timeStamp) : 0;
        var velocityY = prevEvent ? offsetY / (event.timeStamp - prevEvent.srcEvent.timeStamp) : 0;
        return {
          srcEvent: event,
          scale: scale,
          angle: angle,
    ...
    function (_super) {
      ...
      __proto._getScale = function (event) {
        ...
        return event instanceof TouchEvent ? this._getDistance(event.touches[0], event.touches[1]) / this._getDistance(this._firstTouch.touches[0], this._firstTouch.touches[1]) : this.prevEvent.scale;
      };
    ...
    function () {
      ...
      __proto.change = function (input, event, offset, useDuration) {
        if (this._isStopped || !this._itm.isInterrupting() || this._axm.every(offset, function (v) {
          return v === 0;
        })) {
          return;
        }

        var depaPos = this._moveDistance || this._axm.get(input.axes);
        ...
        if (this._moveDistance) {
          this._moveDistance = this._axm.map(destPos, function (v, _a) {
        ...
        if (this._isOutside && this._axm.every(depaPos, function (v, opt) {
          return !isOutside(v, opt.range);
        })) {
          this._isOutside = false;
        }
        ...
        if (useDuration) {
          var duration = this._am.getDuration(destPos, depaPos);

          this._am.stopAnimation(input.axes, changeOption);

          this._am.animateTo(destPos, duration, changeOption);
        } else {
          var isCanceled = !this._em.triggerChange(destPos, false, depaPos, changeOption, true);
      ...
      __proto.release = function (input, event, velocity, inputDuration) {
        ...
        var pos = this._axm.get(input.axes);

        var depaPos = this._axm.get();

        var displacement = this._am.getDisplacement(velocity);

        var offset = toAxis(input.axes, displacement);

        var destPos = this._axm.get(this._axm.map(offset, function (v, opt, k) {
        ...
        var duration = this._am.getDuration(destPos, pos, inputDuration);
        ...
        var userWish = this._am.getUserControl(param);
        ...
        if (isEqual || userWish.duration === 0) {
          if (!isEqual) {
            this._em.triggerChange(userWish.destPos, false, depaPos, changeOption, true);
          }
      ...
      __proto._atOutside = function (pos) {
        ...
        if (this._isOutside) {
          return this._axm.map(pos, function (v, opt) {
          ...
          return this._axm.map(pos, function (v, opt) {
            ...
            if (circular && (circular[0] || circular[1])) {
              ...
              // left
              return min - _this._am.interpolate(min - v, out[0]);
            } else if (v > max) {
              // right
              return max + _this._am.interpolate(v - max, out[1]);
            }
    ...
    function (_super) {
      ...
      function Axes(axis, options, startPos) {
        ...
        _this.axm = new AxisManager(_this.axis);
        ...
        if (startPos) {
          _this.em.triggerChange(startPos);
        }
    ...
    function () {
      ...
      __proto._attachEvent = function (observer) {
        ...
        activeInput.start.forEach(function (event) {
          _this.element.addEventListener(event, _this._onPanstart, false);
        });
        activeInput.move.forEach(function (event) {
          window.addEventListener(event, _this._onPanmove, false);
        });
        activeInput.end.forEach(function (event) {
    ...
    function (_super) {
      ...
      __proto._triggerChange = function (event) {
        ...
        var diff = this._getDifference(this._prevAngle, angle, this._prevQuadrant, quadrant);
