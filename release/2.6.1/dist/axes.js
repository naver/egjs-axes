...
(function (global, factory) {
    ...
    (global.eg = global.eg || {}, global.eg.Axes = factory(global.Hammer,global.getAgent,global.eg.Component));
    ...
    ***************************************************************************** */
    ...
    var IS_IOS_SAFARI = "ontouchstart" in win &&
    getAgent(win.navigator.userAgent).browser.name.indexOf("safari") > -1;
    ...
    function getDirectionByAngle(angle, thresholdAngle) {
      ...
      hammerjs.DIRECTION_VERTICAL : hammerjs.DIRECTION_HORIZONTAL;
    }
    ...
    function useDirection(checkType, direction, userDirection) {
      if (userDirection) {
        return !!(direction === hammerjs.DIRECTION_ALL ||
    ...
    var PanInput = /*#__PURE__*/function () {
      ...
      __proto.onPanmove = function (event) {
          ...
          if (this.isRightEdge) {
            ...
            } else
            {
              ...
              this.rightEdgeTimer = window.setTimeout(function () {
                _this.onPanend(__assign({}, prevInput, { velocityX: 0, velocityY: 0, offsetX: 0, offsetY: 0 }));
              }, 100);
            }
          }
        }
        ...
        useDirection(hammerjs.DIRECTION_HORIZONTAL, this._direction, userDirection),
        useDirection(hammerjs.DIRECTION_VERTICAL, this._direction, userDirection)]);
      ...
      __proto.onPanend = function (event) {
        ...
        [
        useDirection(hammerjs.DIRECTION_HORIZONTAL, this._direction),
        useDirection(hammerjs.DIRECTION_VERTICAL, this._direction)]);
