...
(function (global, factory) {
    ...
    function () {
      ...
      function (_Input) {
        ...
        function TouchMouseInput(_manager, callback) {
          ...
          _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handler", function (manager, inputEvent, inputData) {
    ...
    * @private
    ...
    function () {
      ...
      _defineProperty(Hammer, "VERSION", "2.0.11");
