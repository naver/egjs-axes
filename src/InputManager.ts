...
export class InputManager {
  constructor(core: Axes) {

  }

  onHold(inputType: IInputType, event) {
    if (this.core.interruptManager.isInterrupted())
      return;
    }
    this.core.interruptManager.setInterrupt(true);

    const pos: Position = this._pm.filter(inputType.axes);
