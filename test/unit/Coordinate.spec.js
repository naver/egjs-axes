...
describe("Coordinate", function() {
  describe("getInsidePosition", function() {
      it("should return inner position", () => {
          ...
          // Then
          expect(Coordinate.getInsidePosition(0, range, bounce, circular)).to.be.equal(0);
          expect(Coordinate.getInsidePosition(-1, range, bounce, circular)).to.be.equal(0);
          expect(Coordinate.getInsidePosition(50, range, bounce, circular)).to.be.equal(50);
          expect(Coordinate.getInsidePosition(101, range, bounce, circular)).to.be.equal(100);
          ...
          expect(Coordinate.getInsidePosition(0, range, bounce, circular)).to.be.equal(0);
          expect(Coordinate.getInsidePosition(-1, range, bounce, circular)).to.be.equal(0);
          expect(Coordinate.getInsidePosition(40, range, bounce, circular)).to.be.equal(40);
          expect(Coordinate.getInsidePosition(140, range, bounce, circular)).to.be.equal(100);
      });
      ...
      it("should return inner position with bounce", () => {
          ...
          // Then
          expect(Coordinate.getInsidePosition(0, range, bounce, circular)).to.be.equal(0);
          expect(Coordinate.getInsidePosition(-1, range, bounce, circular)).to.be.equal(-1);
          expect(Coordinate.getInsidePosition(-50, range, bounce, circular)).to.be.equal(-50);
          expect(Coordinate.getInsidePosition(-51, range, bounce, circular)).to.be.equal(-50);
          expect(Coordinate.getInsidePosition(50, range, bounce, circular)).to.be.equal(50);
          expect(Coordinate.getInsidePosition(101, range, bounce, circular)).to.be.equal(101);
          expect(Coordinate.getInsidePosition(200, range, bounce, circular)).to.be.equal(200);
          expect(Coordinate.getInsidePosition(201, range, bounce, circular)).to.be.equal(200);
          ...
          expect(Coordinate.getInsidePosition(0, range, bounce, circular)).to.be.equal(0);
          expect(Coordinate.getInsidePosition(-1, range, bounce, circular)).to.be.equal(0);
          expect(Coordinate.getInsidePosition(-50, range, bounce, circular)).to.be.equal(0);
          expect(Coordinate.getInsidePosition(-51, range, bounce, circular)).to.be.equal(0);
          expect(Coordinate.getInsidePosition(50, range, bounce, circular)).to.be.equal(50);
          expect(Coordinate.getInsidePosition(101, range, bounce, circular)).to.be.equal(100);
          expect(Coordinate.getInsidePosition(200, range, bounce, circular)).to.be.equal(100);
          expect(Coordinate.getInsidePosition(201, range, bounce, circular)).to.be.equal(100);
      });
  });
