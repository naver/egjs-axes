...
import "../../css/demos/character.css";
    ...
    return (
      <Axes axis={this.axis} inputs={this.inputs}>
        {({ pos }) => (
          <div
            className="sun"
            style={{ transform: `scale(${pos.zoom})` }}
  ...
  public render() {
    ...
    return (
      <Axes axis={this.axis} inputs={this.inputs}>
        {({ pos }) => (
          <div
            className={`tree ${this.props.mediaHide ? "mediaHide" : ""}`}
            style={{ right, bottom, transform: `scale(${pos.zoom})` }}
            data-tooltip="Mouse Wheel (WheelInput, PinchInput)"
            data-axis={`zoom: ${pos.zoom}`}
          >
  ...
  public render() {
    return (
      <Axes axis={this.axis} inputs={this.inputs}>
        {({ pos, inputEvent }) => (
          <div
            className={`cloud ${this.props.mediaHide ? "mediaHide" : ""}`}
            style={{
...
class Character extends Component {
  ...
  public render() {
    ...
    return (
      <div
        className={`character ${hair[this.state.hair]} ${look[face]} ${
          this.left
        }`}
        style={{
          left: `${(x / 96) * 80}%`,
      ...
      >
        <div className="inner">
          ...
          <div className="body">
            ...
            <div
              className="arm left"
              style={{ transform: `rotate(${(9 - level) * 12}deg)` }}
            >
            ...
            <div className="legs">
              <div
                className="leg left"
                style={{ transform: `rotate(${(8 - level) * 10}deg)` }}
              >
              ...
              <div
                className="leg right"
                style={{ transform: `rotate(${-(8 - level) * 12}deg)` }}
              >
                <div className="leg-front"></div>
                <div className="foot"></div>
              </div>
...
class App extends Component {
  ...
  public render() {
    return (
      <div className="demobox showcase">
        <Axes
          ref={(axes) => (this.axes = axes)}
          axis={{
            x: [0, 100],
            y: [0, 30],
          }}
          ...
          {({ pos, delta, inputEvent }) => {
            ...
            return (
              <div className={`container ${this.state.className}`}>
                <Sun />
                <Cloud top="120px" left="80%" />
                <Cloud top="80px" left="50%" />
                <Cloud top="140px" left="30%" />
                <div className="broad">
                  <Tree right="25%" bottom="200px" />
                  <Character face="" pos={pos} delta={delta} />
                  <Tree right="5%" bottom="100px" />
                  <Tree right="55%" bottom="100px" />
                </div>
