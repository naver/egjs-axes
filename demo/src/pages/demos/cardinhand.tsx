...
function CardInHand() {
  useEffect(() => {
    ...
    axes.connect("hand top", new PanInput(hand, {
      scale: [0.3, 0.8]
    }));
  });

  return (
    <div codepen="cardinhand">
        ...
        <div className="showcase-item">
          <div className="showcase-content">
            <div id="movableCoordWrapper">
              <div className="hand">
                <div className="handcard"><Icon /></div>
                <div className="handcard"><Icon /></div>
                <div className="handcard"><Icon /></div>
                <div className="handcard"><Icon /></div>
                <div className="handcard"><Icon /></div>
