...
const PullToRefresh = () => {
  useEffect(() => {
    ...
    const getInfo = (pos) => {
      const state =
        pos > 0 ? (pos - axes.axis.scroll.range[1]) / 100 : -pos / 100;
      return {
        isAdd: state > 0.8,
        isTop: pos < 0,
      };
        ...
        <ul id="pull-content">
          <li className="pull_drw">
            <div className="pull_im">
              <img
                src={
                  require("@site/static/img/demos/pulltorefresh/1.jpg").default
                }
                width="110"
              />
            </div>
          ...
          <li className="pull_drw">
            <div className="pull_im">
              <img
                src={
                  require("@site/static/img/demos/pulltorefresh/2.jpg").default
                }
                width="110"
              />
            </div>
          ...
          <li className="pull_drw">
            <div className="pull_im">
              <img
                src={
                  require("@site/static/img/demos/pulltorefresh/3.jpg").default
                }
                width="110"
              />
            </div>
          ...
          <li className="pull_drw">
            <div className="pull_im">
              <img
                src={
                  require("@site/static/img/demos/pulltorefresh/4.jpg").default
                }
                width="110"
              />
            </div>
          ...
          <li className="pull_drw">
            <div className="pull_im">
              <img
                src={
                  require("@site/static/img/demos/pulltorefresh/5.jpg").default
                }
                width="110"
              />
            </div>
          ...
          <li className="pull_drw">
            <div className="pull_im">
              <img
                src={
                  require("@site/static/img/demos/pulltorefresh/6.jpg").default
                }
                width="110"
              />
            </div>
          ...
          <li className="pull_drw">
            <div className="pull_im">
              <img
                src={
                  require("@site/static/img/demos/pulltorefresh/7.jpg").default
                }
                width="110"
              />
            </div>
          ...
          <li className="pull_drw">
            <div className="pull_im">
              <img
                src={
                  require("@site/static/img/demos/pulltorefresh/8.jpg").default
                }
                width="110"
              />
            </div>
          ...
          <li className="pull_drw">
            <div className="pull_im">
              <img
                src={
                  require("@site/static/img/demos/pulltorefresh/9.jpg").default
                }
                width="110"
              />
            </div>
          ...
          <li className="pull_drw">
            <div className="pull_im">
              <img
                src={
                  require("@site/static/img/demos/pulltorefresh/10.jpg").default
                }
                width="110"
              />
            </div>
